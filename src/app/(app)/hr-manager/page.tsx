  ...
  return (
    <>
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <Card className="max-w-6xl mx-auto">
            <CardHeader className="text-center">
                ...
                <CardDescription>This is your personalized dashboard of HR tools.</CardDescription>
            </CardHeader>
            <CardContent>
                {isLoading ? (
      ...
      <Dialog open={isInfoOpen} onOpenChange={setIsInfoOpen}>
          <DialogContent>
              <DialogHeader>
                  <DialogTitle>About the HR Hub</DialogTitle>
                  <DialogDescription>
                      This is your main center for all Human Resources activities.
                  </DialogDescription>
              </DialogHeader>
              <div className="py-4">
                  <p className="text-sm text-muted-foreground">
                      This dashboard displays your "Quick Navigation" items for HR. You can add, remove, and reorder these shortcuts by clicking the "Manage Quick Navigation" button. This allows you to tailor the hub to show the tools you use most frequently.
                  </p>
              </div>
              <DialogFooter>
