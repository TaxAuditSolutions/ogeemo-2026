...
const FeatureDeepDive = ({ isOpen, onOpenChange, feature }: { isOpen: boolean; onOpenChange: (open: boolean) => void; feature: FeatureDetailProps | null }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col p-0 overflow-hidden bg-card text-card-foreground">
                <DialogHeader className="p-6 pb-2 shrink-0 bg-primary/5 border-b">
                    <div className="flex items-center gap-3 text-primary mb-1">
                        <div className="p-2 bg-card rounded-lg shadow-sm border border-primary/10">
            ...
            <main className="flex-1">
                ...
                <section className="bg-muted/30 py-20 border-b">
                    <div className="container px-4 mx-auto text-center space-y-6">
                        ...
                        <div className="w-full max-w-4xl mx-auto aspect-[3/1] rounded-xl overflow-hidden shadow-lg border-4 border-card bg-muted my-8">
                ...
                <section className="py-24 container px-4 mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <Card className="border-primary/10 bg-card text-card-foreground shadow-lg hover:shadow-xl transition-all relative group">
                            <Button 
                                variant="ghost" 
                                size="icon" 
                ...
                <section className="py-24 container px-4 mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl border-8 border-card">
