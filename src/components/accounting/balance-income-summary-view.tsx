...
export function BalanceIncomeSummaryView() {
  ...
  const financialMetrics = useMemo(() => {
    ...
    const totalAssets = accountsReceivable + loansReceivable + totalCapitalAssets;
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <AccountingPageHeader pageTitle="Balance & Income Summary" />
      <div className="flex flex-col items-center">
        <header className="text-center mb-6 max-w-4xl">
          ...
          <p className="text-muted-foreground">
            A high-level overview of your business's financial health.
          </p>
        </header>
        <div className="w-full max-w-5xl space-y-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A snapshot of what your business owns and owes.</CardDescription>
                </CardHeader>
                <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h3 className="font-semibold flex items-center gap-2 text-lg"><Wallet className="h-5 w-5 text-muted-foreground"/> Assets ({formatCurrency(financialMetrics.totalAssets)})</h3>
                        <VitalsCard 
                    ...
                    <div className="space-y-4">
                        <h3 className="font-semibold flex items-center gap-2 text-lg"><Landmark className="h-5 w-5 text-muted-foreground"/> Liabilities & Equity ({formatCurrency(financialMetrics.totalLiabilities + financialMetrics.netEquity)})</h3>
                        <VitalsCard 
