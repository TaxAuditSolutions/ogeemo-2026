  ...
  return (
    <>
      <CardHeader className="text-center">
        ...
        <CardDescription>
            Enter your information below to create your account and join the community. <span className="font-bold text-primary block mt-1">First 30 days are free!</span>
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleInitialSubmit)} className="space-y-4">
                ...
                <p className="text-xs text-center text-muted-foreground pt-2">
                    By clicking "Review Terms", you agree to our Terms of Service.
                </p>
