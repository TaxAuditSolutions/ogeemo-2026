...
const commandMap: Record<string, { target: string; label: string; category: string }> = {
    ...
    'aidispatch': { target: '/ai-dispatch', label: 'AI Co-Pilot', category: 'Intelligence' },
    'dispatch': { target: '/ai-dispatch', label: 'AI Co-Pilot', category: 'Intelligence' },
    'commandcentre': { target: '/ai-dispatch', label: 'AI Co-Pilot', category: 'Intelligence' },
    'commandcenter': { target: '/ai-dispatch', label: 'AI Co-Pilot', category: 'Intelligence' },
    'ogeemoai': { target: '/ai-dispatch', label: 'Ogeemo Co-Pilot', category: 'Intelligence' },
