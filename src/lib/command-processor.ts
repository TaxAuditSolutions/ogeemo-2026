...
const commandMap: Record<string, { target: string; label: string; category: string }> = {
    ...
    'aidispatch': { target: '/ai-dispatch', label: 'AI Dispatch', category: 'Intelligence' },
    'dispatch': { target: '/ai-dispatch', label: 'AI Dispatch', category: 'Intelligence' },
    'commandcentre': { target: '/ai-dispatch', label: 'AI Dispatch', category: 'Intelligence' },
    'commandcenter': { target: '/ai-dispatch', label: 'AI Dispatch', category: 'Intelligence' },
    'ogeemoai': { target: '/ai-dispatch', label: 'Ogeemo AI', category: 'Intelligence' },
